    ...
    public class CsvReporter
    {
        ...
        public void CreateRgvkFile()
        {
            using (StreamWriter writer = new StreamWriter(rgvkPath + $"RGVK_KARAKURTBARAJIVEHES_{DateTime.Now.Date.ToString("yyyyMMdd")}.csv", true))
            {
                ...
                writer.WriteLine("VARSA ILGILI ANLASMA DAHILINDE SENKRON KOMPANSATOR HIZMETI VEREBILEN UNITELERIN SENKRON KOMPANSATOR DURUMUNDAKI ZORUNLU MVAR DEGERLERI (MVAR):;0");
